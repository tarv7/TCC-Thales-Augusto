...
% \begin{figure}[htbp!]
% \centering
% \caption{Comparativo entre tela de login proposta e final}
% \subfloat[ADICIONAR UMA ILUSTRAÇÃO DA FORMA DE CAPTURA]{\includegraphics[width=0.48\textwidth]{figs/mockup/login.jpg}\label{fig:ilustracao_forma_aquisicao_imagem}}
% \hfill
% \subfloat[Imagem obtida com a utilização da câmera e flash forçado]{\includegraphics[width=0.48\textwidth]{figs/resultado/login.png}\label{fig:imagem_adquirida_camera}}
% \legend{Fonte: Elaborada pelo autor}
% \end{figure}
