...
\subfloat[Imagem A]{\includegraphics[width=0.45\textwidth]{figs/brasao_uesc.png}\label{fig:imagem_a}}
\hfill
\subfloat[Imagem B]{\includegraphics[width=0.45\textwidth]{figs/brasao_uesc.png}\label{fig:imagem_b}}
\legend{Fonte: Elaborada pelo autor Y}
\end{figure}
...
\begin{figure}[htbp!]
  ...
  \includegraphics[width=0.25\textwidth]{figs/brasao_uesc.png}
    \legend{Fonte: Elaborada pelo autor X}
    \label{fig:figura_1}
\end{figure}
