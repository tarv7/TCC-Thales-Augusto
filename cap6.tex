...
\subfloat[Imagem A]{\includegraphics[width=0.45\textwidth]{figs/exemplo3.jpg}\label{fig:imagem_a}}
\hfill
\subfloat[Imagem B]{\includegraphics[width=0.45\textwidth]{figs/exemplo3.png}\label{fig:imagem_b}}
...
\begin{figure}[htbp!]
  ...
  \includegraphics[width=0.25\textwidth]{figs/exemplo1.jpg}
