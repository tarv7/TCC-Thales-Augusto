...
Propor uma solução para o problema apresentado por meio de recursos tecnológicos implementando um sistema web para facilitar esse processo mercantil entre o vendedor e comprador no ambiente acadêmico.

\subsection{Objetivos Específicos}
\begin{enumerate}
    \item Desenvolver o \textit{mockup} do sistema
    \item Implementar páginas individuais para cada vendedor da aplicação
    \item Implementar módulo de controle de pedidos
    \item Implementar página de listagem de produtos filtrados por vendedor, universidade e categoria
